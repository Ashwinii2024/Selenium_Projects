...
public class ArrayList_AddAllMethod {
	...
	
	{
		...
		System.out.println("get Method:"+ a1.get(0));
		
		System.out.println("set methods : " +a1.set(1, a1));
		...
		System.out.println("contains :" +a2.contains("Sita"));
